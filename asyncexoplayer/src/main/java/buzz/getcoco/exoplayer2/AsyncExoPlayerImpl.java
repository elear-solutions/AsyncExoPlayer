...
/* package */ final class AsyncExoPlayerImpl extends BasePlayer {

  static {
    ExoPlayerLibraryInfo.registerModule("async.exo.exoplayer");
  }

  private static final String TAG = "AsyncExoPlayerImpl";
  ...
  private final AsyncExoPlayerImplInternal.PlaybackInfoUpdateListener playbackInfoUpdateListener;
  private final AsyncExoPlayerImplInternal internalPlayer;
  ...
  public AsyncExoPlayerImpl(
    ...
    internalPlayer =
        new AsyncExoPlayerImplInternal(
            renderers,
            trackSelector,
            emptyTrackSelectorResult,
            loadControl,
  ...
  public void seekTo(int mediaItemIndex, long positionMs) {
    ...
    if (isPlayingAd()) {
      ...
      AsyncExoPlayerImplInternal.PlaybackInfoUpdate playbackInfoUpdate =
          new AsyncExoPlayerImplInternal.PlaybackInfoUpdate(this.playbackInfo);
  ...
  private void handlePlaybackInfo(AsyncExoPlayerImplInternal.PlaybackInfoUpdate playbackInfoUpdate) {
  ...
  private void updatePlaybackInfo(
    ...
    if (previousPlaybackInfo.offloadSchedulingEnabled != newPlaybackInfo.offloadSchedulingEnabled) {
      for (ExoPlayer.AudioOffloadListener listener : audioOffloadListeners) {
  ...
  private Pair<Object, Long> getPeriodPositionAfterTimelineChanged(
    ...
    Object nextPeriodUid =
        AsyncExoPlayerImplInternal.resolveSubsequentPeriod(
