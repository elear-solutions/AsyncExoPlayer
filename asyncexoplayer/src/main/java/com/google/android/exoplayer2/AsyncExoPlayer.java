...
/**
 * Clone of SimpleExoplayer with tweaks for async playback.
 */
@SuppressWarnings("deprecation, unused")
public class AsyncExoPlayer extends BasePlayer
  ...
  /**
   * A builder for building AsyncExoPlayer.
   */
  public static final class Builder {
    ...
    public Builder(Context context) {
      this(
          context,
          () -> new AsyncRenderersFactory(context),
    ...
    public Builder(Context context, MediaSourceFactory mediaSourceFactory) {
      this(context, () -> new AsyncRenderersFactory(context), () -> mediaSourceFactory);
    }
     ...
     */
    public AsyncExoPlayer build() {
      return buildSimpleExoPlayer();
    }

    /* package */ AsyncExoPlayer buildSimpleExoPlayer() {
      checkState(!buildCalled);
      buildCalled = true;
      return new AsyncExoPlayer(/* builder= */ this);
    }
  }

  private static final String TAG = "AsyncExoPlayer";

  protected final Renderer[] renderers;

  private final ConditionVariable constructorFinished;
  private final Context applicationContext;
  private final AsyncExoPlayerImpl player;
  private final AsyncExoPlayer.ComponentListener componentListener;
  private final AsyncExoPlayer.FrameMetadataListener frameMetadataListener;
   ...
   */
  /* package */ AsyncExoPlayer(Builder builder) {
    ...
    try {
      ...
      componentListener = new AsyncExoPlayer.ComponentListener();
      frameMetadataListener = new AsyncExoPlayer.FrameMetadataListener();
  ...
  public void setVideoSurfaceView(@Nullable SurfaceView surfaceView) {
    ...
    if (surfaceView instanceof VideoDecoderOutputBufferRenderer) {
      ...
      player
          ...
          .setType(AsyncExoPlayer.FrameMetadataListener.MSG_SET_SPHERICAL_SURFACE_VIEW)
  ...
  public void setVideoFrameMetadataListener(VideoFrameMetadataListener listener) {
    ...
    player
        .createMessage(frameMetadataListener)
        .setType(AsyncExoPlayer.FrameMetadataListener.MSG_SET_VIDEO_FRAME_METADATA_LISTENER)
        .setPayload(listener)
        .send();
  }
  ...
  public void setCameraMotionListener(CameraMotionListener listener) {
    ...
    player
        .createMessage(frameMetadataListener)
        .setType(AsyncExoPlayer.FrameMetadataListener.MSG_SET_CAMERA_MOTION_LISTENER)
        .setPayload(listener)
        .send();
  }
  ...
  private final class ComponentListener
    ...
    public void onVideoSizeChanged(VideoSize videoSize) {
      AsyncExoPlayer.this.videoSize = videoSize;
    ...
    public void onSkipSilenceEnabledChanged(boolean skipSilenceEnabled) {
      if (AsyncExoPlayer.this.skipSilenceEnabled == skipSilenceEnabled) {
        return;
      }
      AsyncExoPlayer.this.skipSilenceEnabled = skipSilenceEnabled;
      notifySkipSilenceEnabledChanged();
    }
    ...
    public void onStreamTypeChanged(@C.StreamType int streamType) {
      ...
      if (!deviceInfo.equals(AsyncExoPlayer.this.deviceInfo)) {
        AsyncExoPlayer.this.deviceInfo = deviceInfo;
        // TODO(internal b/187152483): Events should be dispatched via ListenerSet
        for (Listener listener : listeners) {
  ...
  private static final class FrameMetadataListener
    ...
    @Override
    public void onCameraMotion(long timeUs, @NonNull float[] rotation) {
  ...
  public static final class AsyncRenderersFactory extends DefaultRenderersFactory {

    public AsyncRenderersFactory(Context context) {
      super(context);
    }
    ...
    protected void buildVideoRenderers(Context context,
      ...
      MediaCodecVideoRenderer videoRenderer =
          new AsyncMediaCodecVideoRenderer(
              context,
    ...
    protected void buildAudioRenderers(Context context,
      ...
      MediaCodecAudioRenderer audioRenderer =
          new AsyncMediaCodecAudioRenderer(
              context,
              getCodecAdapterFactory(),
              mediaCodecSelector,
              enableDecoderFallback,
